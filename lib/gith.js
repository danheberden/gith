...
var filterSettings = function( settings, payload ) {
  ...
  [ 'repo', 'branch', 'file' ].forEach( function( thing ) {
...
Gith.prototype.simplifyPayload = function( payload ) {
  ...
  payload.commits.forEach( function( commit ) {
    [ 'added', 'modified', 'deleted' ].forEach( function( v ) {
      simpler[ v ].concat( commit[v] );
      simpler.all.concat( commit[v] );
    });
  });
